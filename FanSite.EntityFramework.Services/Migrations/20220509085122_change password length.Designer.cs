...
namespace FanSite.EntityFramework.Services.Migrations
{
    ...
    [Migration("20220509085122_change password length")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FanSite.EntityFramework.Services.Entities.CommentDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FanSite.EntityFramework.Services.Entities.MediaSeriesDto", b =>
                {
                    b.Property<byte>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint")
            ...
            modelBuilder.Entity("FanSite.EntityFramework.Services.Entities.RoleDto", b =>
                {
                    b.Property<byte>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint")
            ...
            modelBuilder.Entity("FanSite.EntityFramework.Services.Entities.UserDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FanSite.EntityFramework.Services.Entities.CommentDto", b =>
                {
                    ...
                    b.HasOne("FanSite.EntityFramework.Services.Entities.UserDto", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("FanSite.EntityFramework.Services.Entities.MediaDto", b =>
                {
                    b.HasOne("FanSite.EntityFramework.Services.Entities.MediaSeriesDto", "Series")
            ...
            modelBuilder.Entity("FanSite.EntityFramework.Services.Entities.UserDto", b =>
                {
                    b.HasOne("FanSite.EntityFramework.Services.Entities.RoleDto", "Role")
                        .WithMany("Users")
